          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 font-bold uppercase tracking-wider text-[10px]">
                ...
                <th className="py-3 px-4">Dosagem Padronizada</th>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b pb-3">
              <h3 className="text-lg font-bold text-slate-800">Novo Medicamento no Estoque</h3>
              <button
            ...
            <form onSubmit={handleSaveMed} className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1">Alerta Estoque Mínimo</label>
                  <input
                    type="number"
